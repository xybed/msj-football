package com.msj.football.config;
...
@Configuration
@MapperScan(basePackages = "com.msj.football.mapper", sqlSessionFactoryRef = "sqlSessionFactory", sqlSessionTemplateRef = "sqlSessionTemplate")
